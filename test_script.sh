...
PIVOTES=pivotes/pivote1.txt
N_PIVOTES=1
INDICE=indices/90_1.txt

RANGO=1
RESULTADO=resultados/pivot_1_rango_1.txt
./cmake-build-debug/query_maker ${CONSULTA} ${PIVOTES} ${N_PIVOTES} ${DICCIONARIO} ${INDICE} ${RANGO} ${RESULTADO}

RANGO=2
RESULTADO=resultados/pivot_1_rango_2.txt
./cmake-build-debug/query_maker ${CONSULTA} ${PIVOTES} ${N_PIVOTES} ${DICCIONARIO} ${INDICE} ${RANGO} ${RESULTADO}

RANGO=3
RESULTADO=resultados/pivot_1_rango_3.txt
./cmake-build-debug/query_maker ${CONSULTA} ${PIVOTES} ${N_PIVOTES} ${DICCIONARIO} ${INDICE} ${RANGO} ${RESULTADO}

RANGO=4
RESULTADO=resultados/pivot_1_rango_4.txt
./cmake-build-debug/query_maker ${CONSULTA} ${PIVOTES} ${N_PIVOTES} ${DICCIONARIO} ${INDICE} ${RANGO} ${RESULTADO}
...
RANGO=1
RESULTADO=resultados/pivot_4_rango_1.txt
./cmake-build-debug/query_maker ${CONSULTA} ${PIVOTES} ${N_PIVOTES} ${DICCIONARIO} ${INDICE} ${RANGO} ${RESULTADO}

RANGO=2
RESULTADO=resultados/pivot_4_rango_2.txt
./cmake-build-debug/query_maker ${CONSULTA} ${PIVOTES} ${N_PIVOTES} ${DICCIONARIO} ${INDICE} ${RANGO} ${RESULTADO}

RANGO=3
RESULTADO=resultados/pivot_4_rango_3.txt
./cmake-build-debug/query_maker ${CONSULTA} ${PIVOTES} ${N_PIVOTES} ${DICCIONARIO} ${INDICE} ${RANGO} ${RESULTADO}
